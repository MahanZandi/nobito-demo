  ...
  return (
    <section className="relative lg:h-[382px]">
      ...
      <div className="flex relative justify-between">
        <Image
          className="object-cover xl:block hidden w-[500px] h-[382px]"
          src="/images/Hotpot(2).png"
          alt="Hotpot image"
          width={500}
          height={383}
        />
        <div className="xl:relative flex flex-col items-center justify-center pt-[30px] lg:pt-0 lg:h-[382px] mx-auto text-center xl:w-[500px] xl:grow">
          ...
          <p className="mt-4 lg:mt-8 text-grey-50 lg:text-xl leading-normal font-normal container">
