        ...
        {links.map((link) => (
            <li key={link.title}>
                ...
                >
                    ...
                    {link.icon && <i className={`text-base leading-4 ${link.icon}`} aria-hidden="true"></i>}
                    {link.title}
                </Link>
            </li>
        ))}
    ...
    <ul className="flex items-center gap-6">
        {socials.map((social) => (
            <li key={social.title}>
                ...
                >
                    <i className={`text-2xl leading-6 ${social.icon}`} aria-hidden="true"></i>
                </Link>
            </li>
        ))}
    </ul>
            ...
            <div className="container">
                <div className="flex items-center gap-10">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button className="w-12 h-12 flex items-center justify-center" aria-label="اعلان‌ها">
                        ...
                        <Link
                            href="/"
                            className="bg-primary-500 w-[117px] h-12 flex items-center justify-center text-white-500 font-t2-medium rounded-lg"
                        >
                            ورود/ثبت نام
                        </Link>
                    </div>
