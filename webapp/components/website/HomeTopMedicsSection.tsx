                ...
                <div key={index}>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="font-b2-bold">{doctor.name}</div>
                    ...
                    >
                      <span>({doctor.happyPatientsPercentage}%)</span>
                      <span>{doctor.happyPatients}</span>
                      <span>بیمار راضی</span>
                    </div>
                    ...
                    <div className="flex whitespace-nowrap gap-2 font-l1-regular text-grey-500">
                      ...
                      نشانی :<span className="truncate">{doctor.location}</span>
                    </div>
                  </div>
                </div>
              ))}
...
export default HomeTopMedicsSection;