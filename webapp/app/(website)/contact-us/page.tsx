  ...
  return (
    <>
      <div className="container xl:mt-10 flex flex-col-reverse xl:flex-row xl:gap-6">
        ...
        <div className="xl:flex-shrink-0 w-full flex justify-center xl:block xl:w-[525px] xl:h-[710px] mt-4 xl:mt-0 -z-10 top-[30px] relative">
          <Image
            priority
      ...
      <div className="mb-2 mt-11 xl:mt-20 xl:mb-[22px]">
        <SocialMedia />
      </div>
    </>
  );
